...
#export IMG_NAME=img.128M.empty.f2fs #should create it beforehand
#export IMG_NAME=img.128M.empty.ext3 #should create it beforehand
#export IMG_NAME=img.128M.empty.btrfs #should create it beforehand
#export IMG_NAME=img.128M.empty.xfs #should create it beforehand
