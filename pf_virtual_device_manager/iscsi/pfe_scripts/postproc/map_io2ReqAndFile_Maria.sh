...
#$abshere/map_io2file_static.py $img_file $formatted_io_file "myEnvironment"  > io2file.static.sim #TC db files is in ./myEnvironment
$abshere/map_io2file_static.py $img_file $formatted_io_file "data" "./data/pfe_db"  > io2file.static.sim 
